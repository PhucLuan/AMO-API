...
namespace Rookie.AMO.IntegrationTests
{
    public class CategoryControllerShould : IClassFixture<SqliteInMemoryFixture>
    {
        ...
        {
            //Arrange
            var category1 = new Category { Name = "Cate 1",Prefix="CA"};
            var category2 = new Category { Name = "Cate 2", Prefix = "CA" };
            var category3 = new Category { Name = "Cate 3", Prefix = "CA" };
            var category4 = new Category { Name = "Cate 4", Prefix = "CA" };
